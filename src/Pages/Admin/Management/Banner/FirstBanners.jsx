...
import { addBanners, deleteBanners, fetchBannerss, updateBanners } from "../../../../redux/slices/bannersSlices.js";
    ...
    return (
        <div className="admin-container">
            ...
            <main className="banner-sections">
                ...
                {!loading && bannerss?.length === 0 && <p className="no-banner">No banners available.</p>}
                {!loading && bannerss?.length > 0 && (
                    <div className="banner-list">
                        {bannerss.map((banners) => (
                            <motion.div
